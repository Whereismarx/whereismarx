export const ui = {
  ...
  en: {
    ...
    homeIntro: "This is my native land.",
    aboutIntro: "These are some basic facts about me.",
    blogIntro: "These are Marx's unadited and uncensored thoughts.",
    switchLang: "中文",
